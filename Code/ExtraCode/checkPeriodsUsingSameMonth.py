...
def isAnomalous(val, median, mad, commodity):
	...
	'''
	# print('val: ', val)
	k = float(KvaluesforMAD[(KvaluesforMAD['COMMODITY'] == commodity) & (KvaluesforMAD['TYPE'] == 'SAMEMONTH')]['K'])
	# print(k, commodity)
...
def getFinalDict(thisMonthMedianDict, sameMonthMedianDict, commodity):
	'''
	GIVEN TWO DICTS:
...
def checkPeriodsUsingSameMonth():
	...
	for commodity in sorted(commodityList):
		...
		finalDict = getFinalDict(thisMonthMedianDict, sameMonthMedianDict, commodity)
