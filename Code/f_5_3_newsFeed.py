...
def generateVolatilityNews():
	...
	volatilityDf.to_csv('../Data/NEWS FEED/volatileNews.csv', index = False)
...
def generateMandiAnomalousNews():
	...
	newsDf = pd.read_csv('../Data/NEWS FEED/combinedNewsRankedTagged.csv')
	# print(newsDf)
	# print(newsDf[(newsDf['PUBLISHEDDATE']>='2019-01-01') & (newsDf['PUBLISHEDDATE']<='2019-12-31')])	
	newsDf = newsDf[newsDf['NUMBER_OF_MATCHED']>=5]
	...
	#SAVING FILES
	anomalousAndArticle.to_csv('../Data/NEWS FEED/anomalousAndArticleMandi.csv', index = False)
	notAnomalousAndArticle.to_csv('../Data/NEWS FEED/notAnomalousAndArticleMandi.csv', index = False)
	anomalousAndNoArticle.to_csv('../Data/NEWS FEED/anomalousAndNoArticleMandi.csv', index = False)
...
def generateRetailAnomalousNews():
	...
	#SAVING FILES
	anomalousAndArticle.to_csv('../Data/NEWS FEED/anomalousAndArticleRetail.csv', index = False)
	notAnomalousAndArticle.to_csv('../Data/NEWS FEED/notAnomalousAndArticleRetail.csv', index = False)
	anomalousAndNoArticle.to_csv('../Data/NEWS FEED/anomalousAndNoArticleRetail.csv', index = False)
...
def mergeMandiAndRetailFiles():
	...
	for kind in kinds:
		mandiFile = '../Data/NEWS FEED/' + kind + 'Mandi.csv'
		retailFile = '../Data/NEWS FEED/' + kind + 'Retail.csv'
		fileToSave = '../Data/NEWS FEED/' + kind + '.csv'
