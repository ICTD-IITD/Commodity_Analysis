...
dx = pd.read_csv('MAHARASHTRA_MUMBAI_Price_LAST_YEAR.csv')
dx['DATE'] = pd.to_datetime(dx['DATE'])

dx["FORECAST"] = pd.read_csv('MAHARASHTRA_MUMBAI_Price_FORECASTED.csv')["PRICE"]
...
# red_patch = mpatches.Patch(color='red', label='The red data', marker='o')
...
plt.title('Anomaly Detection: Last Year (TOMATO: MUMBAI)')
plt.show()
