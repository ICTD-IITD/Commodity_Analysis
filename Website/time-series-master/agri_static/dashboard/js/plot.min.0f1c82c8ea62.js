...
function setOnionChart(){plotChartMandiRetail(type=1,id="plot_mandi_retail_onion_mumbai_1",item="onion",mandi="mumbai",title="Recent 30 days onion price",min_y=101,max_y=15000)
plotChart(type=1,id="plot_mandi_onion_mumbai_1",item="onion",mandi="mumbai",source="mandi",title="Recent 30 days onion price",min_y=101,max_y=12000);plotChart(type=1,id="plot_mandi_onion_bangalore_1",item="onion",mandi="bangalore",source="mandi",title="Recent 30 days onion price",min_y=101,max_y=12000);plotChart(type=1,id="plot_mandi_onion_delhi_1",item="onion",mandi="delhi",source="mandi",title="Recent 30 days onion price",min_y=101,max_y=12000);plotChart(type=2,id="plot_mandi_onion_mumbai_2",item="onion",mandi="mumbai",source="mandi",title="Last 1 year onion price",min_y=101,max_y=12000);plotChart(type=2,id="plot_mandi_onion_bangalore_2",item="onion",mandi="bangalore",source="mandi",title="Last 1 year onion price",min_y=101,max_y=12000);plotChart(type=2,id="plot_mandi_onion_delhi_2",item="onion",mandi="delhi",source="mandi",title="Last 1 year onion price",min_y=101,max_y=12000);plotChart(type=3,id="plot_mandi_onion_mumbai_3",item="onion",mandi="mumbai",source="mandi",title="Full onion price",min_y=101,max_y=12000);plotChart(type=3,id="plot_mandi_onion_bangalore_3",item="onion",mandi="bangalore",source="mandi",title="Full onion price",min_y=101,max_y=12000);plotChart(type=3,id="plot_mandi_onion_delhi_3",item="onion",mandi="delhi",source="mandi",title="Full onion price",min_y=101,max_y=12000);plotChart(type=1,id="plot_retail_onion_mumbai_1",item="onion",mandi="mumbai",source="retail",title="Recent 30 days onion price",400,15000);plotChart(type=1,id="plot_retail_onion_bangalore_1",item="onion",mandi="bangalore",source="retail",title="Recent 30 days onion price",400,15000);plotChart(type=1,id="plot_retail_onion_delhi_1",item="onion",mandi="delhi",source="retail",title="Recent 30 days onion price",400,15000);plotChart(type=2,id="plot_retail_onion_mumbai_2",item="onion",mandi="mumbai",source="retail",title="Last 1 year onion price",400,15000);plotChart(type=2,id="plot_retail_onion_bangalore_2",item="onion",mandi="bangalore",source="retail",title="Last 1 year onion price",400,15000);plotChart(type=2,id="plot_retail_onion_delhi_2",item="onion",mandi="delhi",source="retail",title="Last 1 year onion price",400,15000);plotChart(type=3,id="plot_retail_onion_mumbai_3",item="onion",mandi="mumbai",source="retail",title="Full onion price",400,15000);plotChart(type=3,id="plot_retail_onion_bangalore_3",item="onion",mandi="bangalore",source="retail",title="Full onion price",400,15000);plotChart(type=3,id="plot_retail_onion_delhi_3",item="onion",mandi="delhi",source="retail",title="Full onion price",400,15000);}
function plotChartMandiRetail(type=1,id="plot_mandi_retail_onion_mumbai_1",item="onion",mandi="mumbai",title="Recent 30 days onion price",min_y=101,max_y=12000){var data_to_send_mandi={type,item,mandi,"source":"mandi",};var data_to_send_retail={type,item,mandi,"source":"retail",};Promise.all([requestPostData("/dashboard/getDashBoardData",{data:data_to_send_mandi}),requestPostData("/dashboard/getDashBoardData",{data:data_to_send_retail}),]).then(([mandi_data,retail_data])=>{mandi_x=[];mandi_y=[];retail_x=[];retail_y=[];if(type==1){past=mandi_data["past"]
...
function plotTimeSeriesMandiRetail(id,mandi_x,mandi_y,retail_x,retail_y,type,item,title,min_y,max_y){y_title="Price in ₹ per 100 kg";measure="price";data=[]
mandi_data=[]
retail_data=[]
if(type==1){mandi_data=[{x:mandi_x[0],y:mandi_y[0],type:'scatter',mode:"lines+markers",line:{},name:`${item} ${measure} past original`,connectgaps:false},{x:mandi_x[1],y:mandi_y[1],type:'scatter',mode:'lines+markers',line:{'color':"red",'dash':'dot'},name:`${item} ${measure} past missing`,connectgaps:false},{x:mandi_x[2],y:mandi_y[2],type:'dashed',name:`${item} ${measure} predicted`,connectgaps:false,mode:'lines',line:{dash:'dot',width:4,color:"yellow"}},]}else{mandi_data=[{x:mandi_x[0],y:mandi_y[0],type:'scatter',mode:"lines",line:{width:4,},name:`original`,connectgaps:false},{x:mandi_x[1],y:mandi_y[1],type:'scatter',mode:"lines",line:{color:"red",width:2,},name:`missing`,connectgaps:false},];}
if(type==1){retail_data=[{x:retail_x[0],y:retail_y[0],type:'scatter',mode:"lines+markers",line:{},name:`${item} ${measure} past original`,connectgaps:false},{x:retail_x[1],y:retail_y[1],type:'scatter',mode:'lines+markers',line:{'color':"red",'dash':'dot'},name:`${item} ${measure} past missing`,connectgaps:false},{x:retail_x[2],y:retail_y[2],type:'dashed',name:`${item} ${measure} predicted`,connectgaps:false,mode:'lines',line:{dash:'dot',width:4,color:"yellow"}},]}else{retail_data=[{x:retail_x[0],y:retail_y[0],type:'scatter',mode:"lines",line:{width:4,},name:`original`,connectgaps:false},{x:retail_x[1],y:retail_y[1],type:'scatter',mode:"lines",line:{color:"red",width:2,},name:`missing`,connectgaps:false},];}
