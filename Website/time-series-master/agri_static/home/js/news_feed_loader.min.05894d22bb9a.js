...
function getNewsFeed(){console.log("getNewsFeed")
date=$("#id_news_feed_date").val();commodity=$("#id_news_feed_commoodity").val();showNewsFeedByDate(date,commodity);showAnomalousAndArticleNewsFeedByDate(date,commodity);showAnomalousAndNoArticleNewsFeedByDate(date,commodity);showVolatilityNewsFeedByDate(date,commodity);SELECTED_COMMODITY=capitalizeFirstLetter(commodity);reSequence();}
